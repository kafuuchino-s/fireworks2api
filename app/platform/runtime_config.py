...
PERSISTED_CONFIG_KEYS = {
    ...
    "fireworks_quota_ttl_seconds",
    "fireworks_quota_refresh_concurrency",
    "fireworks_auto_disable_exhausted_accounts",
    "fireworks_quota_background_refresh_enabled",
    "fireworks_quota_refresh_interval_seconds",
    "fireworks_quota_refresh_jitter_seconds",
    "fireworks_quota_refresh_on_startup",
